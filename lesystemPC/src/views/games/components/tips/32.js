export default {
    ...
    // 3143: {
    //     description: "从01-11中，选取3个及以上的号码进行投注，每注需至少包括1个胆码及2个拖码。",
    //     example: "投注方案：胆码 02，拖码 01 06<br>开奖号码：02 01 06 * *（前三顺序不限），即中前三组选胆拖。",
    //     rule: "从01-11中，选取3个及以上的号码进行投注，每注需至少包括1个胆码及2个拖码。<br>所选单注号码与当期顺序摇出的5个号码中的前3个号码相同，顺序不限，即为中奖。",
    //     tpl: "dantuo",
    //     vm: "num1",
    //     algorithm: ["R14", 2, 3],
    //     sub: [["胆码", "拖码"], [1, 11]],
    ...
    // 3144: {
    //     description: "从01-11中，选取2个及以上的号码进行投注，每注需至少包括1个胆码及1个拖码。",
    //     example: "投注方案：胆码 01，拖码 06<br>开奖号码：06 01 * * *，（前二顺序不限），即中前二组选胆拖。",
    //     rule: "从01-11中，选取2个及以上的号码进行投注，每注需至少包括1个胆码及1个拖码。<br>所选单注号码与当期顺序摇出的5个号码中的前2个号码相同，顺序不限，即为中奖。",
    //     tpl: "dantuo",
    //     vm: "num1",
    //     algorithm: ["R14", 1, 2],
    //     sub: [["胆码", "拖码"], [1, 11]],
    ...
    2254: {
        ...
        tpl: "num1",
        algorithm: ["R6"],
        sub: [["第一位", "第二位", "第三位", "第四位", "第五位"], [1, 11]],
        enableMapping: [21053, 21317, 21318, 21319, 21320],
        format: ["n"],
        odds: !0,
        name: "定位胆定位胆"
    },
    2255: {
        ...
        tpl: "num3",
        vm: "num1",
        algorithm: ["R10", null, !0],
        sub: [["定单双"], ["5单0双", "4单1双", "3单2双", "2单3双", "1单4双", "0单5双"]],
        mapping: [21054, 21323, 21325, 21324, 21322, 21321],
        multiOdds: !0,
        name: "趣味型定单双"
    },
    2256: {
        ...
        algorithm: ["R10", null, !0],
        sub: [["猜中位"], [3, 9]],
        mapping: [21055, 21326, 21327, 21328, 21327, 21326, 21055],
        multiOdds: !0,
        name: "趣味型猜中位"
    },
    2265: {
