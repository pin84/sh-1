<template>
  <div class="game-result">
    ...
    <div v-else-if="!noData" class="main-body">
...
<script>
import Top from "@/views/Home/gameResults/top/TopOfficial.vue";
...
export default {
  ...
  methods: {
    ...
    async initData() {
      ...
      let p3 = await this.$get(this.$gapi.ResultGetCodeRank, {
        gameId: id,
