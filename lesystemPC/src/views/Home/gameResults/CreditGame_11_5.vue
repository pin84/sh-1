    ...
    <div class="main-body" v-else>
      ...
      <div class="main-c">
        ...
        <div class="result-box" v-if="curType == 0">
          ...
          <div style="display: flex">
              <List14
              v-for="(title, m) in gameInfo.t2_2"
              :key="m"
              :title="title"
              :titleArr="gameInfo.t2_2_1"
              :dList="allArr2[m]"
            />
          </div>
...
import BallNumListCredit115 from "./common/BallNumListCredit115";
  ...
  methods: {
    ...
    async initData() {
      ...
      list.forEach((item, idx) => {
        ...
        allArr[4][0].push(item.balltdx);
        allArr[4][1].push(item.balltds);

        allArr[5][0].push(item.ball5dx);
        allArr[5][1].push(item.ball5ds);

        allArr2[0][0].push(item.sx);
        allArr2[0][1].push(item.jiou);
