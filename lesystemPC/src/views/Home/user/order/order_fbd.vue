  ...
  <div class="search_content">
    <el-form :inline="true" :model="info">
      ...
      <el-form-item label="注单状态">
        <el-select
          v-model="cruBallStatus"
          placeholder="全部"
          @focus="getBallTypeAndStatus($event)"
          value-key='6'
        >
          <el-option
            v-for="(item, index) in ballStatus"
            :label="item"
            :value="index"
            :key="index"
          ></el-option>
    ...
    <div class="result_content">
      ...
      >
        ...
        <el-table-column label="游戏平台" width="100" prop="gamePlatform">
        </el-table-column>
        <el-table-column label="用戶" width="100" prop="username">
        </el-table-column>
        <el-table-column label="玩法" width="100" prop="gameHall">
        </el-table-column>
        <el-table-column label="盘口" width="100" prop="oddDesc">
        </el-table-column>
        <el-table-column label="赔率" width="100" prop="odds">
        </el-table-column>
        <el-table-column label="下注内容" width="120" prop="betContent">
        </el-table-column>
        <el-table-column label="比赛结果" width="100" prop="marchResults">
        </el-table-column>
      ...
      <div class="total" v-if="this.orderlist.length > 0">
        <el-row>
          ...
          >
          <el-col :span="4"
            >初始资金：<span>{{ subTotal.curScore }}</span></el-col
          >
          <el-col :span="4"
        ...
        <el-row>
          ...
          >
          <el-col :span="4"
            >初始资金：<span>{{ total.curScore }}</span></el-col
          >
          <el-col :span="4"
  ...
  export default {
    ...
    methods: {
      ...
      onsearch_order() {
        ...
        this.orderlist = [];
        let status = this.cruBallStatus == 6 || this.cruBallStatus == '全部' ? -1 : this.cruBallStatus
          console.log(status);
        let d =  {
          ...
          ballType: this.info.current_ballType || -1,
          status,
        ...
        this.$get("Pc.Report.getFBDBetRecord",d).then((res) => {
          if (res.code == 0) {
      ...
      getBallTypeAndStatus() {
        this.$get("Pc.Report.getBallTypeAndStatus", {
          ...
          if (res.code == 0) {
            ...
            this.ballStatus['6'] = '全部'
            console.log(this.ballStatus);
          } else {
            return this.$message.error(res.message);
          }
        });
