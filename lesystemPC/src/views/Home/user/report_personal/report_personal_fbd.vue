  ...
  <div class="search_content">
    ...
    <div class="result_content">
      ...
      >
		...
		<el-table-column label="盈利总和" width="" prop="profit">
		</el-table-column>
		<el-table-column label="实货量" width="" prop="realAmount">
		</el-table-column>
      </el-table>
      <div class="total" v-if="personalChangeList.length > 0">
        <el-row no-gutter>
          <el-col :span="24">
            ...
            <span>{{ personalChangeTotal.winLossAmount }}</span>
			<span>{{ personalChangeTotal.profit }}</span>
			<span class="lastone">{{ personalChangeTotal.realAmount }}</span>
          </el-col>
        </el-row>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    onsearch_BillsList() {
      ...
      this.$get("Pc.Report.fBDGameIndividualReport", {
