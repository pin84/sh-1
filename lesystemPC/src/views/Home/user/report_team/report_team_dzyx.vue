  ...
  <div class="search_content">
    ...
    <div class="result_content">
      ...
      >
        ...
        <el-table-column label="充值" width="" prop="rechargeAmount">
        </el-table-column>
        <el-table-column label="提款" width="" prop="withdrawAmount">
        </el-table-column>
        <el-table-column label="投注人数" width="" prop="buyNumber"> </el-table-column>
        <el-table-column label="投注金额" width="" prop="betAmount" sortable>
        </el-table-column>
        <el-table-column
          label="有效投注"
          width=""
        ...
        <el-table-column label="中奖金额" width="" prop="zhongBonus" sortable>
        </el-table-column>
        <el-table-column label="退水金额" width="" prop="waterAmount" sortable>
        </el-table-column>
        <el-table-column label="返点金额" width="" prop="fandianAmount" sortable>
        </el-table-column>
        <el-table-column label="盈亏" width="" prop="winLossAmount" sortable>
          <template slot-scope="scope">
      ...
      <div class="total" v-if="total_lsit">
        <el-row no-gutter>
          <el-col >
            ...
            <span>{{ total_lsit.waterAmount }}</span>
  ...
  export default {
    ...
    methods: {
      ...
      onSerachLiveGames() {
        ...
        this.$get("Pc.Agent.getTeamElectronicGamesReport", {
