  ...
  <div class="search_content">
    ...
    <div class="result_content">
      ...
      >
        ...
        <el-table-column label="投注人数" width="128" prop="buyNumber"> </el-table-column>
        ...
        <el-table-column label="中奖金额" width="128" prop="zhongBonus" sortable>
        </el-table-column>
        <el-table-column label="中奖金额" width="128" prop="fandianAmount" sortable>
        </el-table-column>
    ...
    methods: {
     ...
     fastDataChange(time) {
      ...
      onSerachLiveGames() {
        ...
        this.$get("Pc.Agent.getTeamSportsGamesReport", {
