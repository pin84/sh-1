  ...
  methods: {
    ...
    addToBasket() {
      ...
      if (this.gameConfig.createBuyObject) {
        ...
        obj.len = arr.length;
        obj.money = this.$util.handlerMoneyDecimal(
          arr.length * radix * this.curRate.ratio * this.curRate.rate
        );
      }
    ...
    createObj() {
      ...
      let obj = {
        ...
        orderStr: "",
        len: 1, //注数
        money: this.$util.handlerMoneyDecimal(
          radix * this.curRate.ratio * this.curRate.rate
        ),
