<template>
  <view class="hezhi">
    <view class="top">
      <view class="left"
        >从1-6中任选3个或多个号码,所选号码与开奖号码的3个号码相同,即为中奖。</view
      >
  ...
  methods: {
    ...
    addToBasketRandom(val) {
      ...
      while (n--) {
        ...
        let numArr = this.$buyDataHandler.createNoReaptRandomNum_2(3, arr);
    ...
    setValue() {
      ...
      let s = this.$buyDataHandler.combinatorialNumber(this.j, 3);
      let num = s;
