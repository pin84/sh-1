...
export default {
	...
	methods: {
		...
		initData() {
			...
			let temArr1 = this.createlist(curObj.C, percentage, [628, 629]);
			let temArr2 = this.createlist(allList[0].C, percentage, ids);
			list2.push(...temArr1, ...temArr2);
			this.list2 = list2;
		},
