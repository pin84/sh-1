...
export default {
  ...
  methods: {
    initPage() {
      let { curGameId: id } = this.$store.state.GDV3.v3IndexGameAllData;
    ...
    handlerData() {
      ...
      if (this.btnIndex === 0 && !flag) {
        ...
        // console.log(canvasDataHandler.handlerData_2(arr));
        // console.log(canvasDataHandler.handlerData_3(arr));
        // console.log(canvasDataHandler.handlerData_4(arr));
      }
    },
