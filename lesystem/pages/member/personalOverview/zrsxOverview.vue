<template>
	<view>
		<ScreenBar ref="ScreenBar" @changeStartTime="changeStartTime" @changeEndTime="changeEndTime" inittimes='12:00:00'></ScreenBar>
	...
	export default {
		...
		methods: {
			...
			getZrsxOverviewList() {
				let self = this
				self.sendRequest({
					url: "System.Member.getMemberLiveGamesTotalReport",
					data: {
					...
					success: res => {
						if (res.code == 0) {
							...
							let result = res.data.liveGameReport;
							// console.log(result)
