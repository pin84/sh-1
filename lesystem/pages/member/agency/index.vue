<template>
  <view class="page-body">
    ...
    <block v-if="gameTypeData[curSelectTitle].code == 'CPYX'">
      ...
      <view class="content">
        ...
        <view class="box">
          ...
          <view class="item">
            <view class="uni-color-warning">{{ daheReturn }}</view>
            <view>打和返款</view>
          </view>
          <view class="item">
          ...
          <view class="item">
            <view class="uni-color-warning">{{ buyReturn }}</view>
            <view>投注返点</view>
          </view>
          <view class="item">
          ...
          <view class="item">
            <view class="uni-color-warning">{{ activityBonus }}</view>
            <view>活动奖励</view>
          </view>
          <view class="item">
    ...
    <block v-if="gameTypeData[curSelectTitle].code == 'YYZB'">
      <YyzbOverview />
    </block>
...
import YyzbOverview from "./yyzbOverview";
export default {
  components: {
    dateTime,
    TitleList,
        ...
        success: (res) => {
          ...
          if (res.code >= 0) {
            let {
              ...
              activityBonus,
              netProfit,
            } = res.data.listReport[0].reportModel;
            ...
            this.fWinningAmount = fWinningAmount;
            this.daheReturn = daheReturn;
