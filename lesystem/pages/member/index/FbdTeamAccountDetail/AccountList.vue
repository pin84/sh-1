      ...
      <block v-if="accountList.selfInfo">
        ...
        <view v-if="listDetailShow['self']">
          ...
          <view class="flex bg-gray text-center row-line">
            ...
            <view class="flex-sub"> 盈利总和 </view>
            <view class="flex-sub">
              {{ stringToFloat(accountList.selfInfo.profit, 3) }}
            </view>
          </view>
          <view class="flex bg-gray text-center row-line">
            <view class="flex-sub">返点金额 </view>
            <view class="flex-sub">{{ stringToFloat(accountList.selfInfo.fandianAmount, 3) }} </view>
            <view class="flex-sub"> 实货量 </view>
            <view class="flex-sub">
              {{ stringToFloat(accountList.selfInfo.realAmount, 3) }}
            </view>
          </view>
        </view>
      </block>
      ...
      <block v-for="(item, index) in accountList.agentList.list" :key="index">
        ...
        <view v-if="listDetailShow[index]">
          ...
          <view class="flex bg-gray text-center row-line">
            <view class="flex-sub"> 实货量 </view>
            <view class="flex-sub">
              {{ stringToFloat(item.realAmount, 3) }}
            </view>
      ...
      <view class="total-bar">
        ...
        <view v-if="listDetailShow['total']">
          ...
          <view class="flex bg-gray text-center row-line">
            ...
            <view class="flex-sub"> 盈利总和 </view>
            <view class="flex-sub">
              {{ stringToFloat(accountList.total.profit, 3) }}
            </view>
          </view>
          <view class="flex bg-gray text-center row-line">
               <view class="flex-sub">返点金额 </view>
            <view class="flex-sub">{{ stringToFloat(accountList.total.fandianAmount, 3) }} </view>
            <view class="flex-sub"> 实货量 </view>
            <view class="flex-sub">
              {{ stringToFloat(accountList.total.realAmount, 3) }}
            </view>
          </view>
        </view>
      </view>
