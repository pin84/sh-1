<template>
  <view class="accountList">
    ...
    <scroll-view v-if="accountList.listReport"  class="list-view bg-white" scroll-y>
      <block
        v-for="(item, index) in accountList.listReport"
        :key="index"
      >
        <view
      ...
      <view
        ...
        v-if="!accountList.listReport || accountList.listReport.length == 0"
      >
