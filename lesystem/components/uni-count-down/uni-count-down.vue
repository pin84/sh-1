<template>
	<view class="uni-countdown">
		<view v-if="showDay&&d>0" :style="{ borderColor: borderColor, color: color, background: backgroundColor }" class="uni-countdown__number">{{ d }}</view>
		<view v-if="showDay&&d>0" :style="{ color: splitorColor }" class="uni-countdown__splitor">{{ showColon ? ':' : '天' }}</view>
