  ...
  <view>
    ...
    >
      <view style="font-size: 20rpx"
        >{{ dates[0][yearIndex] }}/{{ dates[1][monthIndex] }}/{{
          dates[2][dayIndex]
        }}
        {{ dates[3][hourIndex] }}:{{ dates[4][minuteIndex] }}:{{
          dates[5][secondIndex]
        }}</view
      >
    </picker>
  ...
  methods: {
    ...
    setTimeStamp() {
      if (this.selectTime) {
        ...
        if (this.before_month > this.after_month) {
          if (this.month >= 7) {
            ...
            if (this.month > this.before_month) {
              ...
              for (
                let i = this.before_day;
                i <= this.daysNum(year, month);
                i++
              ) {
                this.days.push(this.timeFormat(i));
              }
        ...
        // 获取 时 分 秒 列表
        if (
          this.year == this.before_year &&
          this.month == this.before_month &&
          this.day == this.before_day
        ) {
          for (let i = this.before_hour; i <= 23; i++) {
            this.hours.push(this.timeFormat(i));
          }

          if (this.hour == this.before_hour) {
            for (let i = this.before_minute; i <= 59; i++) {
              this.minutes.push(this.timeFormat(i));
            }
            if (this.minute == this.before_minute) {
          ...
          this.year == this.after_year &&
          this.month == this.after_month &&
          this.day == this.after_day
        ) {
          for (let i = 0; i <= this.after_hour; i++) {
            this.hours.push(this.timeFormat(i));
          }
          if (this.hour == this.after_hour) {
            for (let i = 0; i <= this.after_minute; i++) {
              this.minutes.push(this.timeFormat(i));
            }
            if (this.minute == this.after_minute) {
              // console.log('jinrulepduan - - - -  - -jinrunsdhauifgeufuegfyeguyf')
    ...
    columnChange(e) {
      if (e.detail.column == 0) {
        ...
        if (this.selectMonth == this.before_month) {
          // console.log('yfuwebvilruvaaebuivuervberylbvyuryugf')
          ...
          if (this.selectMonth == this.after_month) {
            ...
            for (
              let i = this.before_day;
              i <= this.daysNum(this.selectYear, this.selectMonth);
              i++
            ) {
              this.dates[2].push(this.timeFormat(i));
            }
          ...
          if (this.selectDay == this.after_day) {
            for (let i = 0; i <= this.after_hour; i++) {
              this.dates[3].push(this.timeFormat(i));
            }
        ...
        // console.log('index - - index - - index - - index - - index - - index - - index - - ')
        ...
        if (
          this.selectYear == this.before_year &&
          this.selectMonth == this.before_month &&
          this.selectDay == this.before_day
        ) {
          for (let i = this.before_hour; i <= 23; i++) {
            this.dates[3].push(this.timeFormat(i));
          }
          if (this.hourIndex > this.dates[3].length - 1) {
            this.hourIndex = this.dates[3].length - 1;
          }
          if (this.hourIndex == 0) {
            for (let i = this.before_minute; i <= 59; i++) {
              this.dates[4].push(this.timeFormat(i));
            }
            if (this.minuteIndex > this.dates[4].length - 1) {
              this.minuteIndex = this.dates[4].length - 1;
            }
            if (this.minuteIndex == 0) {
              for (let i = this.before_second; i <= 59; i++) {
                this.dates[5].push(this.timeFormat(i));
          ...
          this.selectYear == this.after_year &&
          this.selectMonth == this.after_month &&
          this.selectDay == this.after_day
        ) {
          for (let i = 0; i <= this.after_hour; i++) {
            this.dates[3].push(this.timeFormat(i));
          }
        ...
        if (
          ...
          this.selectMonth == this.before_month &&
          this.selectDay == this.before_day &&
          this.selectHour == this.before_hour
        ) {
          for (let i = this.before_minute; i <= 59; i++) {
            this.dates[4].push(this.timeFormat(i));
          }
          ...
          this.selectMonth == this.after_month &&
          this.selectDay == this.after_day &&
          this.selectHour == this.after_hour
        ) {
          for (let i = 0; i <= this.after_minute; i++) {
            this.dates[4].push(this.timeFormat(i));
          }
        ...
        if (
          ...
          this.selectDay == this.before_day &&
          this.selectHour == this.before_hour &&
          this.selectMinute == this.before_minute
        ) {
          // console.log('进入判断——～～～～～')
          ...
          this.selectDay == this.after_day &&
          this.selectHour == this.after_hour &&
          this.selectMinute == this.after_minute
        ) {
          for (let i = 0; i <= this.after_second; i++) {
            this.dates[5].push(this.timeFormat(i));
          }
