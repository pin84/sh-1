        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="配比类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="peibiType">
              <j-dict-select-tag type="radio" v-model="model.peibiType" dictCode="sys_peibi_type" placeholder="请选择配比类型" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/basedata/wmMaduanPeibiSetting/add",
          edit: "/basedata/wmMaduanPeibiSetting/edit",
          queryById: "/basedata/wmMaduanPeibiSetting/queryById"
        }
      }
    },
    computed: {
